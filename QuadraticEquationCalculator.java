...
public class QuadraticEquationCalculator {
    public static void main(String[] args) throws IOException {
        double a, b = 0, c = 0, delta = 0, x1, x2; char rootsNumber = 0;
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        System.out.println("The program calculates the roots of the equation ax^2+bx+c");
        ...
        switch (rootsNumber) {
            case 0:
                System.out.println("There are no realroots");
                break;
            case 1:{
                x1 = -b / (2 * a);
